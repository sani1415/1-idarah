-- teacher_class_bootstrap-এর akhlaq entry-তে 'at' (evaluated_at timestamp) যোগ, admin bootstrap-এর সাথে সামঞ্জস্য রাখতে
-- (একই দিনে একাধিক এন্ট্রির সঠিক ক্রম বজায় রাখতে দরকার, দেখুন: 20260520200225_mdr_akhlaq_timestamp_consistency.sql)।
