-- Restore alhamdulillah fields in teacher class bootstrap (dropped in log review migration).
...
revoke execute on function public.mdr_rel_teacher_class_bootstrap(uuid, text) from public, authenticated;
